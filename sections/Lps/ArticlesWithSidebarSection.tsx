                  ...
                  {group.map((article, index) => (
                    ...
                    >
                      ...
                      <Text
                        ...
                        classes={{
                          container:
                            "font-electrolux font-semibold text-[#041E50] text-[24px] leading-none mb-2 px-4 line-clamp-3 h-[72px]",
                        }}
                      />

                      <p class="text-base text-[#4F4F4F] px-4 leading-[1.4] line-clamp-3 h-[67px]">
                        {article.description}
                      </p>
