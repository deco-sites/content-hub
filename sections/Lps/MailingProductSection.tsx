...
export default function MailingProductSection({
  ...
  ctaLink = "#",
  backgroundImage =
    "https://images.unsplash.com/photo-1753549724481-d146eaa3f0f0?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
}: Props) {
  const id = useId();
      ...
      >
        ...
        <div class="w-full px-4 md:px-6 lg:px-10">
          ...
          <div class="w-full text-center bg-white/80 backdrop-blur-sm rounded-lg py-10 px-4 md:px-10 space-y-6">
            ...
            {description && <p class="text-base text-gray-700">{description}
            </p>}
            <a
              href={ctaLink}
